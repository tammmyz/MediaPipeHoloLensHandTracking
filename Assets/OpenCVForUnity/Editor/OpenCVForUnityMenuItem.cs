...
namespace OpenCVForUnity.Editor
{
    ...
    new Dictionary<BuildTarget, Dictionary<string, string>>() { {BuildTarget.Android,new Dictionary<string, string> () { {
        ...
        public static void SetIOSPluginImportSettings(string pluginsFolderPath, string extraFolderPath, bool displayProgressBar = false)
        {
            ...
            SetPlugins(GetPluginFilePaths(extraFolderPath + "/exclude_contrib/iOS/device"), null, null, displayProgressBar);
            SetPlugins(new string[] { extraFolderPath + "/exclude_contrib/iOS/simulator/opencv2.framework" }, null, null, displayProgressBar);
            SetPlugins(GetPluginFilePaths(extraFolderPath + "/exclude_contrib/iOS/simulator"), null, null, displayProgressBar);
