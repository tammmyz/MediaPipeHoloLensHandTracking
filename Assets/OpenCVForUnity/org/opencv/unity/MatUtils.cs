...
namespace OpenCVForUnity.UnityUtils
{
    public static class MatUtils
    {
        ...
        * <br>This method copies only when mat.isContinuous() is false and mat.dims() = 2. When mat.isContinuous() is true, there is no restriction on the number of mat dimensions.
        *
