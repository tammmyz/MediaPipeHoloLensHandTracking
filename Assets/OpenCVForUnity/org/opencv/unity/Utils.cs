        ...
        {
            {
                ...
                if (format == TextureFormat.RGBA32 || format == TextureFormat.BGRA32 || format == TextureFormat.RGB24 || format == TextureFormat.Alpha8 || format == TextureFormat.R8)
                {
                    ...
                    unsafe
                    {
                        OpenCVForUnity_MatToTexture(mat.nativeObj, (IntPtr)NativeArrayUnsafeUtility.GetUnsafePtr(texture2D.GetRawTextureData<byte>()), (int)format, flip, flipCode, flipAfter);
                    }
                    texture2D.Apply(updateMipmaps, makeNoLongerReadable);
                    ...
                    if ((rawTextureDataBuffer != null) || (pixels32Buffer == null && texture2D.mipmapCount == 1))
                    {
                        ...
                        {                           
                            unsafe
                            {
                                ...
                                fixed (byte* ptr = rawTextureData)
                                {
                                    OpenCVForUnity_MatToTexture(mat.nativeObj, (IntPtr)ptr, (int)format, flip, flipCode, flipAfter);
                                    texture2D.LoadRawTextureData((IntPtr)ptr, rawTextureData.Length);
                                }
                            }
                        }
                        else
                        {                            
                            unsafe
                            {
                                fixed (byte* ptr = rawTextureDataBuffer)
                                {
                                    OpenCVForUnity_MatToTexture(mat.nativeObj, (IntPtr)ptr, (int)format, flip, flipCode, flipAfter);
                                    texture2D.LoadRawTextureData((IntPtr)ptr, rawTextureDataBuffer.Length);
                                }
                            }
                        }
                        texture2D.Apply(updateMipmaps, makeNoLongerReadable);
                ...
                if (pixels32Buffer == null)
                {
                    ...
                    unsafe
                    {
                        ...
                        {
                            OpenCVForUnity_MatToTexture(mat.nativeObj, (IntPtr)ptr, (int)TextureFormat.RGBA32, flip, flipCode, flipAfter);
                        }
                    }
        ...
        {
            {
                ...
                if ((type == CvType.CV_8UC4 && format == TextureFormat.RGBA32) || (type == CvType.CV_8UC3 && format == TextureFormat.RGB24) || (type == CvType.CV_8UC1 && (format == TextureFormat.Alpha8 || format == TextureFormat.R8)))
                {
                    unsafe
                    {
                        OpenCVForUnity_MatToTexture(mat.nativeObj, (IntPtr)NativeArrayUnsafeUtility.GetUnsafePtr(texture2D.GetRawTextureData<byte>()), (int)texture2D.format, flip, flipCode, flipAfter);
                    }
                    texture2D.Apply(updateMipmaps, makeNoLongerReadable);
                }
                else
                {
                    ...
                    unsafe
                    {
                        OpenCVForUnity_MatDataToByteArray(mat.nativeObj, (IntPtr)NativeArrayUnsafeUtility.GetUnsafePtr(texture2D.GetRawTextureData<byte>()));
                    }
                    texture2D.Apply(updateMipmaps, makeNoLongerReadable);
                    if (flipAfter)
                    {
        ...
        {
            {
                ...
                if (format == TextureFormat.RGBA32 || format == TextureFormat.BGRA32 || format == TextureFormat.RGB24 || format == TextureFormat.Alpha8 || format == TextureFormat.R8)
                {
                    ...
                    unsafe
                    {
                        fixed (byte* ptr = texture2D.GetRawTextureData())
                        {
                            OpenCVForUnity_TextureToMat((IntPtr)ptr, mat.nativeObj, (int)format, flipAfter, flipCode);
                        }
                    }
#endif
                ...
                unsafe
                {
                    ...
                    {
                        OpenCVForUnity_TextureToMat((IntPtr)ptr, mat.nativeObj, (int)TextureFormat.RGBA32, flipAfter, flipCode);
                    }
                }
            }
        }
        ...
        {
            {
                ...
                if ((type == CvType.CV_8UC4 && format == TextureFormat.RGBA32) || (type == CvType.CV_8UC3 && format == TextureFormat.RGB24) || (type == CvType.CV_8UC1 && (format == TextureFormat.Alpha8 || format == TextureFormat.R8)))
                {
                    unsafe
                    {
                        fixed (byte* ptr = texture2D.GetRawTextureData())
                        {                           
                            OpenCVForUnity_TextureToMat((IntPtr)ptr, mat.nativeObj, (int)texture2D.format, flipAfter, flipCode);                           
                        }
                    }
                }
                else
